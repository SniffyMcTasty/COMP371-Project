...
#include "../external/Include/ogldev_math_3d.h"
#include "../external/Include/ogldev_texture.h"
#include "../external/Include/ogldev_world_transform.h"
#include "../external/Include/ogldev_basic_mesh.h"
#include "camera.h"
